...
function Index() {
  ...
  return (
    <main className="command-canvas min-h-screen px-5 py-6 md:px-10 lg:px-16">
      <div className="command-bar glass-panel mb-16 flex items-center justify-between px-4 py-3 font-mono text-[10px] uppercase tracking-[0.24em] text-muted-foreground">
        <span className="text-foreground">SPPU ACM / blind coding system</span>
        <span className="flex items-center gap-2 text-signal">
          <span className="size-1.5 rounded-full bg-signal shadow-[0_0_12px_var(--signal)]" />{" "}
          System online
        </span>
      </div>
      <div className="mx-auto grid w-full max-w-[1500px] items-end gap-10 lg:grid-cols-[minmax(0,1fr)_26rem]">
        <div>
          <div className="mb-8 flex items-center gap-5">
            <div className="glass-panel rounded-2xl p-2 shadow-[0_0_40px_-20px_var(--signal)]">
              <img
                src={acmLogo}
            ...
            <p className="font-mono text-[10px] uppercase leading-relaxed tracking-[0.35em] text-signal">
              SPPU ACM presents
              <span className="mt-0.5 block text-muted-foreground">LAN · blind round</span>
            </p>
          </div>
          <div className="mb-10 font-mono text-[10px] uppercase tracking-[0.3em] text-muted-foreground">
            / entry protocol <span className="text-signal">ready</span>
          </div>
          <div className="grid w-full items-end gap-14 lg:grid-cols-[1.1fr_0.9fr]">
            <div>
            ...
            <section className="rounded-2xl border border-border bg-card/90 p-8 shadow-2xl shadow-black/20 ring-1 ring-white/5">
              ...
              <div className="space-y-5">
                ...
                <p className="font-mono text-[11px] leading-relaxed text-muted-foreground">
                  Reloading is safe — your room, hidden code, timer and lives are restored
                  instantly.
                </p>
              </div>
            </section>
